...
/**
  ...
  protected DirectedComponentChain<NeuronsActivation, ? extends ChainableDirectedComponent<NeuronsActivation, ?, ?> , ?, ?> componentChain;
  protected TrailingActivationFunctionDirectedComponentChain<ChainableDirectedComponent<NeuronsActivation, ? extends ChainableDirectedComponentActivation<NeuronsActivation>, ?>> 
   ...
   */
  protected AbstractFeedForwardLayer(DirectedComponentChain<NeuronsActivation, ? extends ChainableDirectedComponent<NeuronsActivation, ?, ?> , ?, ?> componentChain, MatrixFactory matrixFactory) {
	  ...
	  List<ChainableDirectedComponent<NeuronsActivation, ? extends ChainableDirectedComponentActivation<NeuronsActivation>, ?>> chainableComponents = new ArrayList<>();
		for (ChainableDirectedComponent<NeuronsActivation, ?, ?> b : decompose()) {
			chainableComponents.add(b);
		}
